...
/**
 * A dao interface provides methods to access database table <tt>makeploy_carrymode</tt>.
 *
 ...
 *
 * @author guangdong.li
 * @version $Id: CarrymodeDAO.java,v 1.0 2013/10/29 07:34:20 guangdong.li Exp $
 */
public interface CarrymodeDAO {
	/**
