...
/**
 * An ibatis based implementation of dao interface <tt>com.onway.makeploy.common.dal.daointerface.ShopIncomeDAO</tt>.
 *
 ...
 *
 * @author guangdong.li
 * @version $Id: IbatisShopIncomeDAO.java,v 1.0 2013/10/29 07:34:20 guangdong.li Exp $
 */
public class IbatisShopIncomeDAO extends SqlMapClientDaoSupport implements ShopIncomeDAO {
	/**
	...
	Map<String,Object> param = new HashMap<String,Object>();
        ...
        return (ShopIncomeDO) getSqlMapClientTemplate().queryForObject("MS-SHOP-INCOME-SELECT-SHOP-INCOME-INFO-BY-USER-ID-AND-SHOP-ID", param);
    ...
    public int addShopIncome(ShopIncomeDO shopIncome) throws DataAccessException {
        ...
        getSqlMapClientTemplate().insert("MS-SHOP-INCOME-ADD-SHOP-INCOME", shopIncome);

        return shopIncome.getId();
    }
    ...
    public int changeShopIncome(Money incomeAccout, String userId, String shopId) throws DataAccessException {
        ...
        param.put("incomeAccout", incomeAccout);
        param.put("userId", userId);
        param.put("shopId", shopId);

        return getSqlMapClientTemplate().update("MS-SHOP-INCOME-CHANGE-SHOP-INCOME", param);
    }
	...
	Map<String,Object> param = new HashMap<String,Object>();
        ...
        return getSqlMapClientTemplate().queryForList("MS-SHOP-INCOME-SELECT-INCOME-INFO", param);
	...
	Map<String,Object> param = new HashMap<String,Object>();
	    ...
	    Long retObj = (Long) getSqlMapClientTemplate().queryForObject("MS-SHOP-INCOME-SELECT-INCOME-INFO-COUNT", param);
