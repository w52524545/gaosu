...
/**
 * An ibatis based implementation of dao interface <tt>com.onway.makeploy.common.dal.daointerface.DiscountDAO</tt>.
 *
...
public class IbatisDiscountDAO extends SqlMapClientDaoSupport implements DiscountDAO {
	...
	Map<String,Object> param = new HashMap<String,Object>();
        ...
        return getSqlMapClientTemplate().queryForList("MS-DISCOUNT-SELECT-DISCOUNT-INFO-BY-USER-ID-AND-STATUS", param);
	...
	Map<String,Object> param = new HashMap<String,Object>();
	    ...
	    Integer retObj = (Integer) getSqlMapClientTemplate().queryForObject("MS-DISCOUNT-SELECT-DISCOUNT-COUNT-BY-STATUS-AND-USER-ID", param);
	...
	Map<String,Object> param = new HashMap<String,Object>();
        ...
        return getSqlMapClientTemplate().queryForList("MS-DISCOUNT-SELECT-ALL-DISCOUNT-BY-USER-ID", param);
